    ...
    GridInput.prototype.render = function () {
        ...
        return (React.createElement(GridInputContainer, { grid_type: cfg.grid_type, className: class_names },
            ...
            React.createElement("div", { className: "grid_block" }, cfg.options.map(function (item, i) {
                return (React.createElement(StyledGridItem, { color: item.color, grid_type: cfg.grid_type, key: i, className: "grid_item " + (_this.props.value === item.value ? 'active' : ''), onClick: function () {
