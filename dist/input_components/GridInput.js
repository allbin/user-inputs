...
var GridInput = /** @class */ (function (_super) {
    ...
    function GridInput(props) {
        ...
        _this.gridItem = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n            box-shadow: 0 2px 3px rgba(38, 38, 38, 0.12);\n            background-color: #fff;\n            cursor: pointer;\n            border-radius: 4px;\n            padding: ", ";\n            height: ", ";\n            text-align: center;\n            font-size: 12px;\n            &:HOVER{\n                background-color: ", ";\n                opacity: 0.5;\n                color: #fff;\n            }\n            &.active{\n                background-color: ", ";\n                color: #fff;\n                font-weight: bold;\n                &:HOVER{\n                    opacity: 1;\n                }\n            }\n            span{\n                display: ", ";\n            }\n            svg{\n                width: 30px;\n                height: 30px;\n            }\n        "], ["\n            box-shadow: 0 2px 3px rgba(38, 38, 38, 0.12);\n            background-color: #fff;\n            cursor: pointer;\n            border-radius: 4px;\n            padding: ", ";\n            height: ", ";\n            text-align: center;\n            font-size: 12px;\n            &:HOVER{\n                background-color: ", ";\n                opacity: 0.5;\n                color: #fff;\n            }\n            &.active{\n                background-color: ", ";\n                color: #fff;\n                font-weight: bold;\n                &:HOVER{\n                    opacity: 1;\n                }\n            }\n            span{\n                display: ", ";\n            }\n            svg{\n                width: 30px;\n                height: 30px;\n            }\n        "])), function (props) { return props.grid_type === 'icons' ? '6px 0' : '12px 0'; }, function (props) { return props.grid_type === 'colors' || props.grid_type === 'icons' ? '44px' : 'unset'; }, function (props) { return props.grid_type === 'colors' ? props.color : props.theme.colors.dark[1]; }, function (props) { return props.grid_type === 'colors' ? props.color : props.theme.colors.dark[1]; }, function (props) { return props.grid_type === 'colors' || props.grid_type === 'icons' ? 'none' : 'inline-block'; });
        return _this;
    }
