...
export declare type InputType = "bool" | "button" | "date" | "grid" | "number" | "select" | "text";
...
export declare namespace InputHOC {
    ...
    function generateInputs(input_configs: InputConfig[], confirmCB?: (any: any) => void): typeof React.Component;
}
